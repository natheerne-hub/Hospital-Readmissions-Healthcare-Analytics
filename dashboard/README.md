...
The **Python Dashboard** view is implemented. Its metrics are generated by `analysis/build_python_dashboard.py` and published as a traceable JSON asset, allowing visitors to use the dashboard directly without Power BI Desktop.
...
- State-level signals
- Interactive US choropleth map with state rankings and hover details
